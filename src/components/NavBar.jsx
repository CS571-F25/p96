...
/**
 * Responsive AreaRED navbar (no dropdown)
 * - Mobile: brand on first row, nav centered below
 * - Desktop (≥992px): brand left, nav right
 */
    ...
    <Navbar className="navbar-uw navbar-elevated" variant="dark">
      <Container fluid className="navbar-container">
        ...
        <Nav className="nav-row">
          ...
          <Nav.Link as={NavLink} to="/volunteer" className="navlink-pill">
            Volunteer
          </Nav.Link>
          <Nav.Link as={NavLink} to="/get-involved" className="navlink-pill">
            Get Involved
          </Nav.Link>
